...
func TestChannelNetworkTestRouteUsesOperatePermission(t *testing.T) {
	assertChannelRoutePermission(t, http.MethodGet, "/network-test/:id", authz.ChannelOperate, controller.TestChannelNetwork)
}
