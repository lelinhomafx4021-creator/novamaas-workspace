...
func LogTaskConsumption(c *gin.Context, info *relaycommon.RelayInfo) {
	...
	costAccounting := buildCostAccountingInput(info, info.PriceData.Quota)
	if costAccounting != nil {
		costAccounting.EventKey = taskCostAccountingEventKey(info.PublicTaskID)
	}
...
func RefundTaskQuota(ctx context.Context, task *model.Task, reason string) bool {
	...
	model.RecordTaskBillingLog(model.RecordTaskBillingLogParams{
		...
		Group:          task.Group,
		Other:          other,
		CostAccounting: buildTaskCostAccountingInput(task, model.LogTypeRefund, quota),
	})
...
func RecalculateTaskQuota(ctx context.Context, task *model.Task, actualQuota int, reason string, clamps ...*common.QuotaClamp) {
	...
	model.RecordTaskBillingLog(model.RecordTaskBillingLogParams{
		...
		CostAccounting: buildTaskCostAccountingInput(task, logType, logQuota),
	})
}
